...
<p>&nbsp;Anyways, moving on. After accessing all ten text files through the Gutenberg library, I removed stop words, using <a href="https://gist.github.com/sebleier/554280">NLTK&rsquo;s list of English stop words</a>. I then made three different versions of the corpus. The first version was left as is&mdash;stop-worded, but not stemmed or lemmatized. The second version was lemmatized using the NLTK&rsquo;s <a href="https://www.nltk.org/_modules/nltk/stem/wordnet.html">WordNet Lemmatizer</a>. The third version was stemmed using the <a href="https://cran.r-project.org/web/packages/SnowballC/SnowballC.pdf">SnowballC Stemmer</a>.</p>
<p>&nbsp;After that, I ran a Cluster Analysis of each of the three versions in <a href="https://cran.r-project.org/web/packages/stylo/index.html">Stylo</a>. Below, you&rsquo;ll find the results.</p>
